...
node  ./src/index.ts ./rawgrammars/XQuery-40.ebnf > ./transformedgrammars/XQuery-40-full.ebnf
...
node  ./src/index.ts ./rawgrammars/XQuery-31.ebnf > ./transformedgrammars/XQuery-31-full.ebnf
# Assume rex parser is here.
