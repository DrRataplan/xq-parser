...
+-----+-----+-----+
| XQuery Update Facility   | [XQUF 30](https://www.w3.org/TR/xquery-update-30)   | Not implemented. Open for sponsorhsip  |
+-----+-----+-----+
| BaseX   | [XQuery Extensions](https://docs.basex.org/main/XQuery_Extensions)   | Not implemented. Open for sponsorhsip  |
+-----+-----+-----+
| MarkLogic   | [MarkLogic Server Enhanced XQuery Language](https://docs.marklogic.com/9.0/guide/xquery/enhanced)   | Not implemented. Open for sponsorhsip  |
+-----+-----+-----+
